...
public class SlideSwitchH extends View {
    ...
    public SlideSwitchH(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public SlideSwitchH(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideSwitchH(Context context) {
        this(context, null);
    }
